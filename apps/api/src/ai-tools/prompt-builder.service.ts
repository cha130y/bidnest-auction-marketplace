...
6. จัดรูปแบบให้อ่านง่าย: ถ้าคำตอบมีหลายขั้นตอนหรือหลายรายการ ให้ขึ้นบรรทัดใหม่แล้วเริ่มแต่ละข้อด้วย "- " และเว้นบรรทัดว่างคั่นระหว่างย่อหน้า ใช้ **ข้อความ** เพื่อเน้นคำสำคัญเท่านั้น ห้ามใช้รูปแบบ markdown อื่นนอกจากนี้ (ไม่มีหัวข้อ #, ไม่มีตาราง)`;
