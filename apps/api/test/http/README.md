...
| `08-auction.http` | ประมูล: สร้าง draft ส่วนตัว + ตรวจสอบก่อนเผยแพร่ + preview/publish + หน้าสาธารณะ + แก้ไข/ยกเลิก + จบประมูล + เคสที่ต้องพังของฝั่งประมูล (AUC-001..007) |
